...
//   UserDefaultValues.hasSeenAppIntro = false  use like this
//UserDefaultValues.$hasSeenAppIntro.removeValue() use dollar sign to remove values

//To store Objects or array -- just Remove Bodymagic and give your model
//struct UserProfileCache {
//    static let key = "userProfileCache"
//    static func save(_ value: [BodyMagic]!) {
//         UserDefaults.standard.set(try? PropertyListEncoder().encode(value), forKey: key)
//    }
//    static func get() -> [BodyMagic]! {
//        var userData: [BodyMagic]!
//        if let data = UserDefaults.standard.value(forKey: key) as? Data {
//            userData = try? PropertyListDecoder().decode([BodyMagic].self, from: data)
//            return userData!
//        } else {
//            return userData
//        }
...
////    }
////    let int = [1,2,3,4]
////    let strings = ["hello","you","tube","!"]
////
//////    for (int,string) in zip(int,strings){
//////
//////    }
//}
//@dynamicMemberLookup
//struct Person{
//    let tips:Tips
//    subscript<T>(dynamicMember keyPath: KeyPath< Tips, T>) -> T{
//        return tips[keyPath: keyPath]
//    }
//}

//static var is Lazy by default
//struct Content{
//    lazy var expensiveToCompute = {(0...1000).reduce(0,+)}()
//}
//var cont = Content()
//cont.expensiveToCompute
